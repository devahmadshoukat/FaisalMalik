  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Faisal Malik",
          from_email: form.email,
          to_email: "iamfaisalofficial01@gmail.com",
      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a
              href="mailto:iamfaisalofficial01@gmail.com"
              target="_blank"
              className="blue-text-gradient"
            >
              iamfaisalofficial01@gmail.com
            </a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
            <a
              href="https://api.whatsapp.com/send/?phone=923259176560&text&app_absent=0&lang=en"
              target="_blank"
              className="blue-text-gradient"
            >
              +92 3259176560
